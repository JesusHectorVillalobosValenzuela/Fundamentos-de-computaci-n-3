...
//        int array [] = {1,30,6,8,9,10,15,20,16,2};
//        float prom = 0;
//        int mayor = 0, menor=999999, n =0, suma = 0;
//        for (int i = 0; i < array.length; i++) {
//            System.out.print(array[i]+" - ");
//            menor = Menor(array[i], menor);
//            mayor = Mayor(array[i],mayor);
//            suma = suma+array[i];
//            n++;
//        }
//        System.out.println("\n");
//        prom = (float) promedio(suma,n);
...
//        System.out.println("\n");
    ...
    public static double promedio(int suma, int n) {
        double a = 0;
        a = suma / n;
        return a;
    ...
    public static void DespliegaArreglo(int arr[]) {
        for (int i = 0; i < arr.length; i++) {
