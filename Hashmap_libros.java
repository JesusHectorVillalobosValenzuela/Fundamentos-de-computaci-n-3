...
public class Hashmap_libros {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Libro> resultado = Busca_hash_map(biblioteca, autor);
    ...
    public static List<Libro> Busca_hash_map(HashMap<String, List<Libro>> biblioteca, String autor) {
    ...
    public static HashMap<String, List<Libro>> Crea_biblioteca(List<Libro> libros) {
        ...
        for (Libro l : libros) {
            boolean Exist = mapa.containsKey(l.autor);
            if (Exist == true) {
